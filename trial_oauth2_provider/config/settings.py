"""
Django settings for trial_oauth2_provider project.
...
SECRET_KEY = 'django-insecure-&bmq_s7mq1m06$4n_#h*w1!@#cdrbp+5yj6fc7dhjxk0l@qdsn'
...
ROOT_URLCONF = 'trial_oauth2_provider.config.urls'
...
WSGI_APPLICATION = 'trial_oauth2_provider.config.wsgi.application'
...
# LOGIN_URL='/v1/users/sign-in/'

CORS_ORIGIN_ALLOW_ALL = True
ALLOWED_HOSTS = ["chrome-extension://fhbjgbiflinjbdggehcddcbncdddomop"]
ALLOWED_HOSTS += ['198.211.99.20', 'localhost', '127.0.0.1']

CORS_ORIGIN_WHITELIST = ["chrome-extension://fhbjgbiflinjbdggehcddcbncdddomop"]
